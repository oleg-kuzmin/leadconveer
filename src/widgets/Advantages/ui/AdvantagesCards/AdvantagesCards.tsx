  ...
  return (
    <div className={cn(styles.AdvantagesCards, className)}>
      <AdvantageCard
        ...
        imgSrc="/leadconveer/images/advantages-smartphone-x1-optimized.png"
      ...
      <AdvantageCard
        ...
        imgSrc="/leadconveer/images/advantages-men-x1-optimized.png"
      ...
      <AdvantageCard
        ...
        imgSrc="/leadconveer/images/advantages-basket-x1-optimized.png"
      ...
      <AdvantageCard
        ...
        imgSrc="/leadconveer/images/advantages-laptop-x1-optimized.png"
        imgAlt="Ноутбук"
      />
    </div>
  );
